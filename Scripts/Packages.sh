...
# 常用工具与应用
UPDATE_PACKAGE "luci-app-tailscale" "asvow/luci-app-tailscale" "main"   #虚拟局域网 VPN
UPDATE_PACKAGE "ddns-go" "sirpdboy/luci-app-ddns-go" "main"   #ddns-go
UPDATE_PACKAGE "diskman" "lisaac/luci-app-diskman" "master"   #磁盘管理
UPDATE_PACKAGE "easytier" "EasyTier/luci-app-easytier" "main"   #easytier
#UPDATE_PACKAGE "fancontrol" "rockjake/luci-app-fancontrol" "main"   #风扇控制
...
UPDATE_PACKAGE "netspeedtest" "sirpdboy/luci-app-netspeedtest" "master" "" "homebox speedtest speedtest-cli"   #网速测试
